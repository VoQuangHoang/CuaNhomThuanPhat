					...
					<div class="card card-secondary card-outline card-tabs">
						<div class="card-header p-0 pt-1 border-bottom-0">
							<ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" id="custom-tabs-three-brands-seo-tab" data-toggle="pill" href="#custom-tabs-three-brands-seo" role="tab" aria-controls="custom-tabs-three-brands-seo" aria-selected="false">Nội dung SEO</a>
								</li>
							</ul>
						</div>
						<div class="card-body">
				...
				<div class="col-12 col-sm-3">
					<div class="card card-secondary card-outline">
						<div class="card-header">
							<h3 class="card-title">Đăng thương hiệu</h3>
						</div>
						<div class="card-body">
							<div class="form-group">
