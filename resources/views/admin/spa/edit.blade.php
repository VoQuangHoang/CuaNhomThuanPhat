...
@section('content')
	<div class="container-fluid">
       	...
       	<form action="{{ route('spa.update', $data->id) }}" method="POST">
			@csrf
            @method('put')
			<div class="row">
							...
							<div class="tab-content" id="custom-tabs-three-tabContent">
									...
									<div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" name="category_id">
                                                    ...
                                                    @foreach($categories as $cate)
                                                        <option value="{{$cate->id}}" {{old('category_id', $data->category_id) == $cate->id ? 'selected' : ''}}>{{ $cate->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
										...
										{{-- <div class="col-sm-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="short_desc" cols="30" rows="3">{!! old('short_desc', $data->short_desc) !!}</textarea>
											</div>
										</div> --}}
								...
								<div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel" aria-labelledby="custom-tabs-three-profile-tab">
									<div class="form-group">
										...
										<label style="float: right;">Số ký tự đã dùng: <span id="countTitle">{{ $data->meta_title != null ? mb_strlen( $data->meta_title, 'UTF-8') : 0 }}/60</span></label>
									...
									<div class="form-group">
										...
										<label style="float: right;">Số ký tự đã dùng: <span id="countMeta">{{ $data->meta_description != null ? mb_strlen( $data->meta_description, 'UTF-8') : 0 }}/160</span></label>
						...
						<div class="card-body">
							<div class="form-group">
								<div class="custom-control custom-checkbox">
									<input class="custom-control-input" type="checkbox" {{ old('status',$data->status) == 1 ? 'checked' : null }} name="status" id="showCheckbox1" value="1">
