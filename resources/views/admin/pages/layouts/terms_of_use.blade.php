                ...
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="setting-tab" data-toggle="pill" href="#setting" role="tab"
                            aria-controls="setting" aria-selected="true">Content</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    <div class="tab-pane fade show active" id="setting" role="tabpanel" aria-labelledby="setting-tab">
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="" id="">
                                    <table class="table table-bordered table-hover page-table">
                                        <?php 
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control content" name="content[content]">{{ @$contents->content }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
