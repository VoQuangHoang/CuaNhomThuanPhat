							...
							<div class="tab-content" id="custom-tabs-three-tabContent">
								<div class="tab-pane fade show active" id="custom-tabs-brands" role="tabpanel" aria-labelledby="custom-tabs-brands-tab">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="code" value="{!! old('code', generateRandomCode(6)) !!}">
									</div>
									...
									<div class="form-group">
									  ...
									  <select class="form-control" name="type">
										<option value="1" {{old('type') == 1 ? 'selected' : ''}}>Giảm theo %</option>
										<option value="2" {{old('type') == 2 ? 'selected' : ''}}>Giảm theo giá tiền</option>
									  </select>
									</div>

									<div class="form-group">
										<label>Giá trị giảm <small>(phụ thuộc loại)</small></label>
										<input type="number" min="1" class="form-control" name="value" value="{!! old('value') !!}">
									</div>
