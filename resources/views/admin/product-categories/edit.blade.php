...
@section('content')
	<div class="container-fluid">
       	...
       	<form action="{{ route('product-categories.update', $data->id) }}" method="POST">
			@csrf
            @method('put')
			<div class="row">
					...
					<div class="card card-secondary card-outline card-tabs">
						<div class="card-header p-0 pt-1 border-bottom-0">
							<ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true">Chi tiết danh mục</a>
								</li>
								<li class="nav-item">
								...
								<div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
									...
									<div class="form-group">
										...
										<select class="custom-select" name="parent_id">
											...
											@php menuMulti($categories, 0, '', old('parent_id', $data->parent_id)) @endphp
										</select>
									</div>

									<div class="form-group">
										<label for="">Mô tả danh mục</label>
										<textarea class="form-control content" name="description">{!! old('description',$data->description) !!}</textarea>
									</div>
							...
							<div class="form-group">
								<div class="custom-control custom-checkbox">
									<input class="custom-control-input" type="checkbox" name="popular" id="catePopular"
										value="1" {{old('popular', $data->popular) == 1 ? 'checked' : ''}}>
