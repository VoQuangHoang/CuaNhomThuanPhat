                                ...
                                <div class="repeater" id="repeater">
                                    <table class="table table-bordered page-table">
                                        <?php if(!empty($data->more_image)){
                                            $contents = json_decode($data->more_image);
                                        } ?>
                                        @if(old('list', $data->more))
                ...
                <div class="card card-secondary card-outline">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <option value="1" {{old('status', $data->status) == 1 ? 'selected' : ''}}>Công khai</option>
                            <option value="2" {{old('status', $data->status) == 2 ? 'selected' : ''}}>Chờ duyệt</option>
                            <option value="3" {{old('status', $data->status) == 3 ? 'selected' : ''}}>Thùng rác</option>
                            </select>
                        </div>
                        <hr>
                ...
                <div class="card card-secondary card-outline">
                    ...
                    <div class="card-body">
                        <div class="form-group" style="overflow:auto; max-height:600px">
                            <?php menuMultiPost($categories,0,$str='',old('category', $array_id)); ?>
                        </div>
                    </div>
                </div>
                <div class="card card-secondary card-outline">
