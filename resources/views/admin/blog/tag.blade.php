...
@section('controller_route', route('blog-tags.index'))
@section('action','List')
@section('content')
<!-- Main content -->
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 col-sm-4">
            <form action="{{ route('blog-tags.store') }}" method="POST" autocomplete="off">
                @csrf
                            ...
                            <tbody>
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" data-href="{{ route('blog-tags.update', $item->id ) }}"
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-sm btn-danger btn-destroy"
                                                data-href="{{ route('blog-tags.destroy', $item->id) }}"
