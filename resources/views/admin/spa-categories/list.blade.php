...
@section('controller','Danh mục spa')
@section('controller_route', route('spa-categories.index'))
@section('action','List')
@section('content')
<!-- Main content -->
                            ...
                            <tbody>
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('home.spa.single', $item->slug)}}">{{route('home.spa.single', $item->slug)}}</a>
                                        </td>
                                        <td>
                                            <a href="{{ route('spa-categories.edit', $item->id ) }}"
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-sm btn-danger btn-destroy"
                                                data-href="{{ route('spa-categories.destroy', $item->id) }}"
