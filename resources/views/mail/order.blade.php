        ...
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0">
            <tr>
                <td valign="top">
                        ...
                        <tr>
                            <td align="center">
                                <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        <td class="esdev-adapt-off es-p20" align="left">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="font-size: 0px"><a
                                                                        target="_blank" href="{{route('home.index')}}">
                                                                        <amp-img
                                                                            src="https://ywjnov.stripocdn.email/content/guids/CABINET_953c28dc6c267f608330967e35b5973e/images/logo.png"
                                                                            alt="Logo" style="display: block"
                                                                            width="120" title="Logo" height="124">
                                                                        </amp-img>
                                                                    </a></td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p5t es-p5b">
                                                                    <p>Đơn hàng của bạn đã được chuyển đi. Dưới đây là
                                                                        một số thông tin về thời điểm nhận gói hàng của
                                                                        bạn và cách theo dõi gói hàng đó trong suốt quá
                                                                        trình.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <tr>
                            <td align="center">
                                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <span class="es-button-border">
                                                                        <a href="{{route('home.index')}}" class="es-button" target="_blank">
                                                                            Track Your Order
                                                                        </a>
                                                                    </span>
                                                                </td>
                                                ...
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <h2 style="line-height: 150%">ĐƠN HÀNG # {{$data->sku}}</h2>
                                                                    <p style="line-height: 150%">{{date_format($data->created_at,'d/m/Y')}}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" class="es-m-txt-c es-p20t">
                                                                    <p style="color: #a0937d">DANH SÁCH SẢN PHẨM</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-p5t es-p5b"
                                    ...
                                    <tr>
                                        <td class="es-p20t es-p20r es-p20l esdev-adapt-off" align="left">
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" style="font-size: 0px">
                                                                                <a
                                                                                    target="_blank"
                                                                                    href="{{route('home.product_single', $item->Product->slug)}}">
                                                                                    <amp-img class="adapt-img p_image" src="{{asset($item->Product->image)}}"
                                                                                        alt="{{$item->Product->name}}" style="display: block" width="125"
                                                                                        title="{{$item->Product->name}}" height="125" layout="responsive">
                                                                                    </amp-img>
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                            ...
                                                            <tr>
                                                                <td width="125" align="left">
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="es-p20t es-p20b es-m-p0t es-m-p0b es-m-txt-l">
                                                                                <h3><strong class="p_name">{{$item->Product->name}}</strong></h3>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td width="176" align="left">
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="right"
                                                                                class="es-p20t es-p20b es-m-p0t es-m-p0b">
                                                                                <p style="color: #666666"
                                                                                    class="p_description">x{{$item->qty}}</p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td width="74" align="left">
                                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                        <tr>
                                                                            <td align="right" class="es-p20t es-p20b es-m-p0t es-m-p0b">
                                                                                <p class="p_price">{{number_format($item->total_price, 0, '', '.')}} ₫</p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                    ...
                                    @endforeach
                                    <tr>
                                        <td class="es-p20 esdev-adapt-off" align="left">
                                            <table width="560" cellpadding="0" cellspacing="0" class="esdev-mso-table">
                                                <tr>
                                                    <td class="esdev-mso-td" valign="top">
                                                        <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                        <tr>
                                                                            <td align="center" style="font-size: 0px"><a
                                                                                    ...
                                                                                    <amp-img class="adapt-img p_image"
                                                                                        src="https://ywjnov.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/80061620297487223.png"
                                                                                        alt="Sony WH-1000XM4"
                                                                                        style="display: block"
                                                                                        width="125"
                                                                ...
                                                                <td width="125" align="left">
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                class="es-p20t es-p20b es-m-p0t es-m-p0b es-m-txt-l">
                                                                                <h3><strong class="p_name">Sony
                                                                                        WH-1000XM4</strong></h3>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                    ...
                                    <tr>
                                        <td class="es-p20r es-p20l esdev-adapt-off" align="left">
                                            <table width="560" cellpadding="0" cellspacing="0" class="esdev-mso-table">
                                                <tr>
                                                    <td class="esdev-mso-td" valign="top">
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                                ...
                                                                <td width="466" align="left">
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="right">
                                                                                <p>
                                                                                    Tổng tiền<br>Giảm giá<br>Phí giao hàng<br>
                                                                                    <b>Tổng thanh toán ({{count($data->OrderDetail)}}&nbsp;sản phẩm)</b>
                                                                                </p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <td width="74" align="left">
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="right">
                                                                                <p>
                                                                                    {{number_format($data->OrderDetail->sum('total_price'), 0, '', '.')}} ₫<br>
                                                                                    {{number_format($data->sale_price+$data->discount_price, 0, '', '.')}} ₫<br>
                                                                                    {{number_format($data->shipping_fee, 0, '', '.')}} ₫<br>
                                                                                    <strong>{{number_format($data->total_price, 0, '', '.')}} ₫</strong>
                                                                                </p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                ...
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-txt-c es-p20t">
                                                                    <p style="color: #a0937d">THÔNG TIN ĐẶT HÀNG</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-p5t es-p5b"
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <p>
                                                                        <span>Người nhận: {{$data->name}}</span><br>
                                                                        Số điện thoại {{$data->phone}}<br>
                                                                        Email: {{$data->email}}<br>
                                                                        Địa chỉ: {!! getFullAddressVTP($data) !!}<br>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <tr>
                            <td align="center">
                                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                    cellspacing="0" width="600">
                                    <tr>
                                        <td class="es-p30t es-p20r es-p20l" align="left">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p5t es-p5b"
                                                                    ...
                                                                    <table border="0" width="100%" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                style="border-bottom: 1px solid #999999;background: none;height: 1px;width: 100%;margin: 0px">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-p10t">
                                                                    <h2><b>Any Questions?</b></h2>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" class="es-p5t es-p5b">
                                                                    <p>For everything else you want to know…</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                    ...
                                    <tr>
                                        <td class="es-p20b es-p20r es-p20l es-m-p10r es-m-p10l" align="left">
                                                ...
                                                <tr>
                                                    <td width="265" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            role="presentation">
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p10b"><span
                                                                        class="es-button-border"
                                                                        style="display: block"><a
                                                                            href="{{route('home.index')}}"
                                                                            class="es-button" target="_blank"
                                                                            style="border-left-width: 20px;border-right-width: 20px;display: block">Delivery
                                                                            FAQ</a></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p10b"><span
                                                                        ...
                                                                        style="display: block"><a
                                                                            href="{{route('home.index')}}"
                                                                            class="es-button" target="_blank"
                                                                            style="border-left-width: 20px;border-right-width: 20px;display: block">Returns
                                                                            FAQ</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p10b"><span
                                                                        ...
                                                                        style="display: block"><a
                                                                            href="{{route('home.index')}}"
                                                                            class="es-button" target="_blank"
                                                                            style="border-left-width: 20px;border-right-width: 20px;display: block">Order
                                                                            FAQ</a></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p10b"><span
                                                                        ...
                                                                        style="display: block"><a
                                                                            href="{{route('home.index')}}"
                                                                            class="es-button" target="_blank"
                                                                            style="border-left-width: 20px;border-right-width: 20px;display: block">Visit
                                                                            Customer Care</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" class="es-content" align="center">
                        <tr>
                            <td align="center" bgcolor="#fef8ed" style="background-color: #fef8ed">
                                <table bgcolor="#fef8ed" class="es-content-body" align="center" cellpadding="0"
                                    cellspacing="0" width="600" style="background-color: #fef8ed">
                                    <tr>
                                        <td class="es-p15t es-p15b es-p20r es-p20l es-m-p10r es-m-p10l" align="left">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr class="links-images-left">
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                id="esd-menu-id-0"><a target="_blank"
                                                                                    ...
                                                                                    style="color: #a0937d">
                                                                                    <amp-img
                                                                                        src="https://ywjnov.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/58991620296762845.png"
                                                                                        alt="FREE DELIVERY"
                                                                                        title="FREE DELIVERY" width="25"
                                                                                        height="25"
                                                                                        style="margin-right:15px">
                                                                                    </amp-img>FREE DELIVERY
                                                                                </a></td>
                                                                            <td align="center" valign="top"
                                                                                width="33.33%"
                                                                                class="es-p10t es-p10b es-p5r es-p5l"
                                                                                style="border-left: 1px solid #a0937d"
                                                                                id="esd-menu-id-1"><a target="_blank"
                                                                                    href="{{route('home.index')}}"
                                                                                    style="color: #a0937d">
                                                                                    <amp-img
                                                                                        src="https://ywjnov.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/55781620296763104.png"
                                                                                        alt="HIGH QUALITY"
                                                                                        title="HIGH QUALITY" width="25"
                                                                                        height="25"
                                                                                        style="margin-right:15px">
                                                                                    </amp-img>HIGH QUALITY
                                                                                </a></td>
                                                                            <td align="center" valign="top"
                                                                                width="33.33%"
                                                                                class="es-p10t es-p10b es-p5r es-p5l"
                                                                                ...
                                                                                id="esd-menu-id-2"><a target="_blank"
                                                                                    ...
                                                                                    style="color: #a0937d">
                                                                                    <amp-img
                                                                                        src="https://ywjnov.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/88291620296763036.png"
                                                                                        alt="BEST CHOICE"
                                                                                        title="BEST CHOICE" width="25"
                                                                                        height="25"
                                                                                        style="margin-right:15px">
                                                                                    </amp-img>BEST CHOICE
                                                                                </a></td>
                                                ...
                                                <tr>
                                                    <td width="560" align="left">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr class="links">
                                                                            ...
                                                                            <td align="center" valign="top" width="25%"
                                                                                ...
                                                                                style="padding-bottom: 10px"><a
                                                                                    target="_blank"
                                                                                    href="{{route('home.index')}}."
                                                                                    style="color: #666666">The shops</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p10b"
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="top"
                                                                                class="es-p20r"><a target="_blank"
                                                                                    href="{{route('home.index')}}">
                                                                                    <amp-img title="Facebook"
                                                                                        src="https://ywjnov.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                class="es-p20r"><a target="_blank"
                                                                                    ...
                                                                                    <amp-img title="Twitter"
                                                                                        src="https://ywjnov.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                class="es-p20r"><a target="_blank"
                                                                                    ...
                                                                                    <amp-img title="Instagram"
                                                                                        src="https://ywjnov.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                                                        alt="Inst" width="32"
                                                                                        height="32"></amp-img>
                                                                                </a></td>
                                                                            <td align="center" valign="top"><a
                                                                                    ...
                                                                                    <amp-img title="Youtube"
                                                                                        src="https://ywjnov.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p10b">
                                                                    <p style="font-size: 12px;color: #666666">You are
                                                                        receiving this email because you have visited
                                                                        our site or asked us about the regular
                                                                        newsletter. Make sure our messages get to your
                                                                        Inbox (and not your bulk or junk folders).<br><a
                                                                            target="_blank"
                                                                            style="font-size: 12px;color: #a0937d"
                                                                            href="{{route('home.index')}}">Privacy
                                                                            policy</a> | <a target="_blank"
                                                                            style="font-size: 12px;color: #a0937d">Unsubscribe</a>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
